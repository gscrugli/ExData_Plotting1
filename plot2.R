plot2 <- function(directory=getwd(),filename="household_power_consumption.txt") {
        ...
        #png(file="plot2.png")
        with(my_data,lines(DateTime,Global_active_power,ylab="Global Active Power (kilowatts)"))
        #dev.off()
}